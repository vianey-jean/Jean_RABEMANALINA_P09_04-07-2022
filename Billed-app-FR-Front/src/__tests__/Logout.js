...
describe('Étant donné que je suis connecté', () => {
  describe('Quand je clique sur le bouton de déconnexion', () => {
    test(('Ensuite, je devrais être envoyé à la page de connexion'), () => {
