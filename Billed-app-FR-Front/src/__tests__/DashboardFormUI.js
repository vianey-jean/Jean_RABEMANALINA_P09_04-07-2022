...
describe('Étant donné que je suis connecté en tant quadministrateur et que je suis sur la page du tableau de bord', () => {
  describe('Lorsque les données de facturation sont transmises à DashboardUI', () => {
    test(('Ensuite, il faut les mettre dans la page'), () => {
  ...
  describe('Lorsque la facture en attente est transmise à DashboardUI', () => {
    test(('Ensuite, il devrait afficher le bouton et la zone de texte'), () => {
  ...
  describe('Lorsque la facture acceptée est transmise à DashboardUI', () => {
    test(('Ensuite, il devrait afficher les commentaires de ladministrateur'), () => {
      const html = DashboardFormUI(billAccepted)
      document.body.innerHTML = html
      expect(screen.getByText(bill.commentAdmin)).toBeTruthy()
    })
  })
  describe('Lorsque la facture refusée est transmise à DashboardUI', () => {
    test(('Ensuite, il devrait afficher les commentaires de ladministrateur'), () => {
